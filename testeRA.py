...
df = pd.DataFrame(lista_reclamacoes, columns=['identificador', 'titulo', 'datahora', 'local', 'status', 'texto', 'resposta', 'pagina'])
#df.sort_values(by=['identificador'])
#df.drop_duplicates()
#print(df)

df.to_excel("D:\\Dropbox\\_workspace\\wspython\\arquivos gerados\\reclamacoesExcel.xlsx", encoding='utf-8-sig') 
df.to_csv("D:\\Dropbox\\_workspace\\wspython\\arquivos gerados\\reclamacoesCSV.csv", encoding='utf-8-sig')
"""
